...
// Future<void> runIsolate(List<PluginMain> pluginMains, SendPort sendPort) async {
//   _IsolateChannel? channel;

//   await runZonedGuarded(
//     () async {
//       final registeredPlugins = <PluginMain, PluginBase>{};
//       channel = _IsolateChannel(sendPort, registeredPlugins);

//       for (final main in pluginMains) {
//         Zone.current.runGuarded(() => registeredPlugins[main] = main());
//       }
//     },
//     (error, stackTrace) => channel?.handleError(error, stackTrace),
//     zoneSpecification: ZoneSpecification(
//       print: (self, parent, zone, line) => channel?.handlePrint(line),
//     ),
//   );
// }

// class _IsolateChannel extends Channel {
//   _IsolateChannel(this.sendPort, super.registeredPlugins)
//       : _receivePort = ReceivePort() {
//     sendPort.send((Object? event) {
//       _receivePort.sendPort.send(event);
//     });
...
//   @override
//   Stream<Object?> get input => _receivePort;
